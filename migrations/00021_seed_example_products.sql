...
INSERT INTO price_lists (id, tenant_id, name, description, list_type, is_active) VALUES
    ('c0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Retail', 'Default retail pricing for all customers', 'default', true);

-- Price list entries for all SKUs (using base_price_cents from product_skus)
INSERT INTO price_list_entries (tenant_id, price_list_id, product_sku_id, price_cents, is_available) VALUES
    -- Ethiopia Yirgacheffe
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 1895, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002', 1895, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000003', 3495, true),
    -- Colombia Huila
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004', 1695, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000005', 1695, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000006', 2995, true),
    -- Guatemala Antigua
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000007', 1795, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000008', 1795, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000009', 3195, true),
    -- Sumatra Mandheling
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000010', 1695, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000011', 1695, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000012', 2995, true),
    -- House Blend
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000013', 1495, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000014', 1495, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000015', 2695, true),
    ('00000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000016', 5995, true);
...
DELETE FROM price_list_entries WHERE price_list_id = 'c0000000-0000-0000-0000-000000000001';

DELETE FROM price_lists WHERE id = 'c0000000-0000-0000-0000-000000000001';
