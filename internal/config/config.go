...
func New() (*Config, error) {
	...
	// Validate log level
	valid := cfg.logLevel == "info" || cfg.logLevel == "debug" || cfg.logLevel == "warn" || cfg.logLevel == "error"
	if !valid {
		slog.Default().Warn("Warning: invalid log level. Using default level: info", slog.String("value", cfg.logLevel))
		cfg.logLevel = "info"
	}
